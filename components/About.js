    ...
    return(
        <div className="about">
            <OpenWindow style={{zIndex: 999}} title="about.txt" margin={["20vh", "2vw", null, null]} icon="user-circle">
                <p>I'm a sophomore at MIT majoring in Computer Science and Neuroscience, with an intended minor in Linguistics.</p>
                <p>I'm currently a head of the development team at <a target="_blank" href="http://hackmit.org/">HackMIT</a> where I also am a project manager for our <a target="_blank" href="https://apps.apple.com/us/app/hackmit/id1582182786">mobile app</a>. I'm also a UI/UX design and front-end engineer intern at the MIT Media Lab.</p>
                <p>In the past, I've developed algorithms for a <a target="_blank" href="/files/3D Depth Imaging for Assistive Guidance.pdf">computer vision research project</a> where we utilized 3D depth imaging for assistive guidance. I've also made a prototype social media platform at Fintech Focus and worked on autonomous robots during my time competing in FIRST Robotics.</p>
                <p>I also compete with <a target="_blank" href="http://mitmocktrial.weebly.com/">MIT Mock Trial</a> and take photos for <a target="_blank" href="https://issuu.com/mit_infinite">Infinite Magazine</a>. I love to cook, travel, and learn new languages. Currently, I'm learning Korean!</p>
            </OpenWindow>
