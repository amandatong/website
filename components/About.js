    ...
    return(
        <div className="about">
            <OpenWindow style={{zIndex: 999}} title="about.txt" margin={["20vh", "2vw", null, null]} icon="user-circle">
                ...
                <p>I'm currently the head of the development team at <a target="_blank" href="http://hackmit.org/">HackMIT</a>. Most recently, I wrapped up an internship in Seoul, South Korea with Hyundai Motor Company in their division working on a smart factory in Singapore.</p>
